...
def initConfig():
	...
	setCell( "vk_login", "99365970117" ) # Логин от аккаунта ВК
	setCell( "vk_password", "Best2015a.best" ) # Пароль от аккаунта ВК

	setCell( "app_id", 2685278 ) # Приложение, у которого есть доступ взаимодействовать с ВК
	setCell( "telegram_token", "6440974321:AAHj_GHFuOl4G58A_3wvMVO2NmvQ8bpVuyI" ) # Токен ботинка в Telegram
	...
	setCell( "vk_14", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_15", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_16", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_20", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_21", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_17", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_12", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_7", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_18", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_23", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_4", '5643488222' ) # Пример переадресации из чата ВК в Telegram
	setCell( "vk_210008338", '5643488222' ) # Пример переадресации из чата ВК в Telegram

	#setCell( "t_5643488222", '14' ) # Пример переадресации из чата ВК в Telegram
